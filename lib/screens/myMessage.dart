...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  double animOneBegin = 0.0;
  double animOneEnd = 1.0;
  double animTwoBegin = 0.0;
  double animTwoEnd = 1.0;
  late final AnimationController _controllerOne = AnimationController(
    duration: const Duration(seconds: 1),
    vsync: this,
  );
  late final AnimationController _controllerTwo = AnimationController(
    duration: const Duration(seconds: 1),
    vsync: this,
  );
  late final AnimationController _controllerThree = AnimationController(
    duration: const Duration(seconds: 1),
    vsync: this,
  );
  ...
  void initState() {
    ...
    sequenceAnimation = new SequenceAnimationBuilder()
        ...
        .addAnimatable(
            animatable: new ColorTween(begin: Colors.white, end: Colors.yellow),
            from: const Duration(milliseconds: 400),
            to: const Duration(milliseconds: 500),
            tag: "color2",
            curve: Curves.bounceInOut)
        .addAnimatable(
            animatable: new ColorTween(begin: Colors.white, end: Colors.red),
                        ...
                        return new Center(
                          child: Row(
                            ...
                            children: [
                              ...
                              new Container(
                                decoration: BoxDecoration(
                                    color: sequenceAnimation["color2"].value,
                                    borderRadius: BorderRadius.circular(15)),
                                height: 15.0,
                                width: 15.0,
                              ),
                              ...
                              new Container(
                                decoration: BoxDecoration(
                                    color: sequenceAnimation["color3"].value,
                                    borderRadius: BorderRadius.circular(15)),
                                height: 15.0,
                                width: 15.0,
                              ),
